...
class Triple {
    ...
    typedef typename TypeTraits<T1>::on_input T1_on_input;
    typedef typename TypeTraits<T1>::on_modify T1_on_modify;
    typedef typename TypeTraits<T2>::on_input T2_on_input;
    typedef typename TypeTraits<T2>::on_modify T2_on_modify;
    typedef typename TypeTraits<T3>::on_input T3_on_input;
    typedef typename TypeTraits<T3>::on_modify T3_on_modify;
